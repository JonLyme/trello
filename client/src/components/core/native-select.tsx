...
const nativeSelectStyles = cva(
  'bg-input-background peer border-base-300 text-title-50 focus:border-input-primary-focus-border focus:ring-input-primary-focus-border/20 disabled:border-base-100 disabled:text-input-disabled-text disabled:placeholder:text-input-disabled-text w-full appearance-none rounded-lg border px-4 py-2.5 pr-11 outline-none focus:ring-4',
  {
    variants: {
      variant: {
        default: '',
