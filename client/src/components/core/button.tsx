...
export const buttonStyles = cva(
  'flex items-center justify-center gap-3 rounded-lg font-medium transition outline-none focus:ring-3 disabled:pointer-events-none [&>svg]:text-current!',
  {
    variants: {
      variant: {
        primary: '',
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        // Disabled styles
        className:
          'disabled:bg-button-outline-disabled-background disabled:border-button-outline-disabled-border disabled:text-button-outline-disabled-text border',
      },
      {
        variant: 'primary',
        appearance: 'fill',
